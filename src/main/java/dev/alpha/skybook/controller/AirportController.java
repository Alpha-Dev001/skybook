...
public class AirportController {
    ...
    public ApiResponse<AirportResponse> createAirport(@Valid @RequestBody AirportRequest request) {
        return ApiResponse.success("Airport created successfully",airportService.createAirport(request));
    }
    ...
    @PutMapping("/{id}")
    public ApiResponse<AirportResponse> updateAirport(@PathVariable Long id,@Valid @RequestBody AirportRequest request) {
        return ApiResponse.success(
